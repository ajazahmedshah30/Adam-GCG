#!/bin/bash
#SBATCH --job-name=eval-momentum-a40-full
...
#SBATCH --output=eval_momentum_a40_full.%j.out
#SBATCH --error=eval_momentum_a40_full.%j.err

set -euo pipefail

echo "===== JOB START (A40 - FULL EVAL MOMENTUM) ====="
date
hostname
...
run_eval () {
    ...
    for TASK in "${TASKS[@]}"; do
        ...
        LOG_FILE="${LOG_DIR}/eval_momentum_full_${ATTACK}_${TASK}_${SLURM_JOB_ID}.log"
