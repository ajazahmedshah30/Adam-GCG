...
#SBATCH --output=eval_adam_a40.%j.out
#SBATCH --error=eval_adam_a40.%j.err

set -euo pipefail

echo "===== JOB START (A40 - EVAL ADAM) ====="
date
hostname
...
run_eval () {
    ...
    for TASK in "${TASKS[@]}"; do
        ...
        LOG_FILE="${LOG_DIR}/eval_adam_${ATTACK}_${TASK}_${SLURM_JOB_ID}.log"
